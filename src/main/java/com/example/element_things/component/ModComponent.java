...
public class ModComponent {
    ...
    public static final ComponentType<NbtComponent> ENTITY_MESSAGE = Registry.register(Registries.DATA_COMPONENT_TYPE,Identifier.of(ElementThingsMod.MOD_ID,"entity_message"),ComponentType.<NbtComponent>builder().codec(NbtComponent.CODEC).build());
